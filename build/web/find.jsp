<%-- 
    Document   : find
    Created on : Nov 21, 2018, 10:57:31 PM
    Author     : Denny
--%>
...
<body>
       <%
		...
		Connection conn=DriverManager.getConnection(myUrl,"root","");
                String query="Select dname,cnumber from details where location= '"+loc+"' or ctype='"+typ+"'";
                //step 3:
			...
			<div class="wrap-login100 p-l-110 p-r-110 p-t-62 p-b-33">
				<form class="login100-form validate-form flex-sb flex-w" action="forgot.jsp">
					...
					<div class="p-t-31 p-b-9">
						<span class="txt1">
                                                    Your Driver is <%out.println(rs.getString("dname")); %>
						</span>
					</div>
					<div class="p-t-31 p-b-9">
						<span class="txt1">
                                                    Car Number is <%out.println(rs.getString("cnumber")); %>
						</span>
					</div>
